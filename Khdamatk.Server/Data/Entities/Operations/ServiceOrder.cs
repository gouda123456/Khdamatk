...
{
    Pending,   // يعني لسه مستني
    Accepted,  // تم القبول (دي اللي ناقصة عندك)
    Rejected,  // تم الرفض (ودي كمان ناقصة)
    Completed, // تم التنفيذ
    Canceled ,  // تم الإلغاء
    // مرحلة ما قبل بدء العمل
               // الطلب تم إنشاؤه ولكن لم يتم اتخاذ أي إجراء بعد
    ...
    // مرحلة الإغلاق (ناجح)
             // العميل وافق على التسليم، الطلب اكتمل بنجاح
